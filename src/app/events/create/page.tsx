...
function CreateEventContent() {
  ...
  const handleSaveDraft = handleSubmit((data: CreateEventFormData) => onSubmit(data, EventStatus.DRAFT))
  const handlePublish = handleSubmit((data: CreateEventFormData) => onSubmit(data, EventStatus.PENDING))
    ...
    <div className={styles.container}>
      ...
      {!isLoaded ? (
        ...
        <div className={styles.actions}>
          <Button type="button" variant="secondary" onClick={handleSaveDraft} disabled={createEventMutation.isPending}>
            Save as Draft
          </Button>
          <Button type="button" variant="primary" onClick={handlePublish} disabled={createEventMutation.isPending}>

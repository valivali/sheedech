...
function FireworksBackground({
  ...
  const containerClasses = [styles.fireworksBackground, className].filter(Boolean).join(' ');
  const canvasClasses = [styles.fireworksCanvas, canvasProps?.className].filter(Boolean).join(' ');
...
export { FireworksBackground, type FireworksProps };
